    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="../index2.html" class="logo">
                ...
                <span class="logo-mini"><b>U</b>SUKM</span>
            ...
            <section class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Penghitungan Zakat</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="col-xs-12">
                                    <p> Rumus Perhitungan Zakat yaitu dengan Harga Emas dikali Pajak dikali Zakat = Jumlah Kena Zakat </p>
                                </div>
                            </div>
                            <!-- /.box-body -->
                        </div>
