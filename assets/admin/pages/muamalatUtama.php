...
include "../koneksi.php";
$ambil_data = mysqli_query("select * from muamalat where status='1' order by id_muamalat desc limit $offset, $dataPerPage",$koneksi);
$hitung_record = mysqli_query("SELECT COUNT(*) AS jumData FROM muamalat",$koneksi);
