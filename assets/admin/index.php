            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Naufaldi</span>
                </a>
            ...
            <li class="treeview">
              <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="pages/muamalatUtama.php"><i class="fa fa-circle-o"></i> Posting Muamalat</a></li>
                    <li><a href="pages/muamalah.php"><i class="fa fa-circle-o"></i> Buat Posting</a></li>
                </ul>
            </li>
            <li class=" treeview">
              <a href="pages/emaszakat.ph">
                <i class="fa fa-pie-chart"></i>
